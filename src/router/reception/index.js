...
const CommoditySnapshot = r => require.ensure([], () => r(require('@/pages/reception/commoditySnapshot/index')), 'commoditySnapshot')
...
export default {
  ...
  children: [
    ...
    {
      path: '/commoditySnapshot',
      meta: {
        title: '商品快照'
      },
      name: 'commoditySnapshot',
      component: CommoditySnapshot
    }
  ]
}
