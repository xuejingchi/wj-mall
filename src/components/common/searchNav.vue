  ...
  <div class="search-body">
    <div class="search-img" v-if="showAdd">
      <div class="bg" @click="supplierEnter">
        <i @click="closeAd" class="el-icon-error"></i>
      </div>
    </div>
    <div class="search-nav">
      <div class="seacrh clearfix">
        <div class="log f-l clearfix">
          <router-link :to="{path: '/'}">
            <img class="logo" src="http://mall.vandream.com:8081/group1/M01/00/14/rBCwJFswoFWAE-msAAB1FaaMtgE537.png" alt="" width="350">
