        ...
        <ul class="list-item">
          ...
          <li class="vertical" v-if="userInfo.companyFlag === '2' && userInfo.companyStatus ==='3' && userInfo.userId !== '' && userInfo.userId !== undefined && userInfo.userId !== 'null'" >
            ...
            <div class="item type">
              ...
              <div class="down-user-set">
                <ul>
                  <template v-if="userCookie.menuList.buyer">
                    <li v-for="item in userCookie.menuList.buyer.menuList">
          ...
          <li class="vertical" v-if="userInfo.companyFlag === '1' && userInfo.companyStatus ==='3' && userInfo.userId !== '' && userInfo.userId !== undefined && userInfo.userId !== 'null'">
            ...
            <div class="item type">
              ...
              <div class="down-user-set">
                <ul>
                  <template v-if="userCookie.menuList.supplier">
                    <li v-for="item in userCookie.menuList.supplier.menuList">
                      <span @click="toPath(item)">{{ item.name }}</span>
                    </li>
                  </template>
                  <li>
