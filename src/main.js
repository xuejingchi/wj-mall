...
if (process.env.NODE_ENV === 'formal') {
  // 上传图片地址
  Vue.prototype.FileUploadUrl = 'http://mall.vandream.com:8081/node/file_upload' // 线上
...
} else if (process.env.NODE_ENV === 'sit') { // 预发环境
  // 上传图片地址
  ...
  // 测试环境
  // 上传图片地址
  Vue.prototype.FileUploadUrl = 'http://192.168.5.14:8081/node/file_upload'

  // 服务器图片域名、项目路径
  Vue.prototype.ServerImgUrl = 'http://192.168.5.14:8081/'

  // 商品图片地址路径
  Vue.prototype.goodsImgUrl = 'http://192.168.5.14:8081/'

  Vue.prototype.urlLink = 'http://192.168.5.14/'
} else {
  // 上传图片地址
  Vue.prototype.FileUploadUrl = 'http://192.168.5.11:8081/node/file_upload'

  // 服务器图片域名、项目路径
  Vue.prototype.ServerImgUrl = 'http://192.168.5.11:8081/'

  // 商品图片地址路径
  Vue.prototype.goodsImgUrl = 'http://192.168.5.11:8081/'

  Vue.prototype.urlLink = 'http://192.168.5.11/'
}
