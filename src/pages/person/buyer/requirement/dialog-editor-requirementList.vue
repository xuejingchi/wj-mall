        ...
        <div class="dialog-content">
          <ul class="list-table">
            ...
            <li class="list-item clearfix">
              ...
              <div class="list-text">
                <i class="iconfont" style="color:rgb(28, 110, 235)">&#xe620;</i><a style="font-size: 12px;color: #1C6EEB;" @click="DownloadFile(content.list.accessory.textUrl, content.list.accessory.listTtext)">{{ content.list.accessory.listTtext }}</a>
              </div>
            </li>
            <li class="list-item clearfix">
              <div class="list-title no-border">{{ content.list.upTime.listTitle }}</div>
              <div class="list-text no-border">{{ content.list.upTime.listTtext | timeFormat('YYYY-MM-DD  HH:mm:ss') }}</div>
            </li>
          </ul>
        </div>
      </div>
