    ...
    <div class="contract-box">
      ...
      <div class="content" v-for="(items, index) in contractList">
        ...
        <ul class="body">
          <li class="label-1">
            {{items.contractName}}
            <p v-if="!items.isChanged">[订单中商品有变更]</p>
          </li>
          ...
          <li class="label-5">
            <p v-if="items.contractStatus === '06' || items.contractStatus === '10' || items.contractStatus === '11' || items.contractStatus === '20'">已受理</p>
            <p v-if="items.contractStatus === '00'">关闭</p>
          ...
          <li class="label-7">
            <div v-if="items.noticeStatus === '30' || items.noticeStatus === '40' || items.noticeStatus === '90'" @click="deliveryNotice(items.contractId,items)" :id="items.contractId+'_notice'">
            ...
            <li class="label-6">
              <el-popover
                ...
                <div class="logistics" v-if="logistics.logisticsName != undefined">
                  ...
                  <div class="bottom" v-if="curLogisticsList.length === 2 && (logistics.logisticsList.length > 2) ">
                    <span>· 以上为最新跟踪信息</span>
    ...
    methods: {
      ...
      handleSelect (key) {
        ...
        switch (key) {
          ...
          // 已受理
          case '2':
            this.params.contractStatus = '100'
            this.params.paymentStatus = ''
            this.params.DeliveryStatus = ''
            break
          // 待确认
      ...
      deliveryInfo(id, items) {
        ...
        let noticeSpan
        if (noticeDiv) {
          noticeSpan = noticeDiv.lastChild
        }
        let noticeBox = document.getElementById(`${id}_notice_box`)
          ...
          res => {
            ...
            if (data.code === 200) {
              ...
              if (this.logistics.logisticsList.length > 2) {
                ...
                this.curLogisticsList = this.logistics.logisticsList
              }
            }
          }
        ).catch(
