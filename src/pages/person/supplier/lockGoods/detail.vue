    ...
    <div class="detail">
      ...
      <div class="info">
        ...
        <div class="right">
          ...
          <div>收货地址<span class="mr-l">{{address}}</span></div>
          <div>派发单号<span class="mr-l">{{dispatchCode}}</span></div>
          <div>平台联系人<span style="margin-left:37px" class="mr-l">{{purchaser}}</span><span style="margin-left:25px">{{contactPhone}}</span></div>
        </div>
