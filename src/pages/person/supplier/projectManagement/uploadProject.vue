    ...
    <div class="status" v-show="status !== '20'">
      <div class="status-style">
        ...
        <div class="upload" v-show="status === '10'">您可以：
          ...
          <span class="col-18" @click="uploadDemo" ref="upload" style="margin-left:30px" v-if="standardFlag === 'N'">上传方案</span>
        </div>
        <!-- 25方案审核被驳回 -->
    ...
    <div class="detail">
      ...
      <div class="purchase">
        ...
        <div class="right">
          ...
          <a @click="downLoadRequeriment" class="upload">下载采购需求</a>
        </div>
        <div style="clear:both"></div>
      </div>
      ...
      <div class="solution" v-show="standardFlag === 'N'">
            ...
            <el-table
              ...
              <el-table-column
                ...
                <template slot-scope="scope">
                  ...
                  <span v-if="scope.row.status === '25'">方案已驳回</span>
                  ...
                  <span v-if="!scope.row.status" style="color:#ccc;">方案未采纳</span>
                </template>
              </el-table-column>
            </el-table>
          </div>
      ...
      <div class="submit" v-show="(status === '10' || status === '25') && standardFlag === 'N'">
      ...
      getDetail () {
        ...
        getSolutionInfo(params).then((response) => {
          if (response.data.code === 200) {
            ...
            this.standardFlag = data.standardFlag
            // this.status = 30
