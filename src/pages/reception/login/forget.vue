  ...
  <div id="login">
    <div class="shadow">
      <ul class="header">
        ...
        <li class="back" @click="backHp">返回</li>
      </ul>
    </div>
    <div class="forget-content">
      <div class="body">
        ...
        <p class="des1" v-if="curProgress === 1">手机验证码验证，请确认是本人操作，以完成以下验证:</p>
        <ul class="auth" v-if="curProgress === 1">
          <li class="one">
            <span><i>*</i>登陆手机</span>
            <el-input class="input" v-model="one.phoneNumber"
                      @change="checkPhone" ref="phone1"
                      placeholder="请输入手机号">
            </el-input>
          ...
          <li class="four">
            <el-button :disabled="!one.verifyCode.length || !one.phoneNumber" type="primary" @click="next">下一步</el-button>
          </li>
        </ul>
        ...
        <div class="finish" v-if="curProgress === 3">
          ...
          <el-button class="button" @click="goPage" type="primary">返回登陆</el-button>
        </div>
        <p class="des2">有任何问题请联系客服</p>
        <p class="des3">400-826-7880</p>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    checkPhone() {
      ...
      funSets.verifyPhoneExist(params).then(
        res => {
