<template>
  <div class="hp">
      ...
      <div class="hp-header">
        <div class="first-nav clearfix">
          <el-carousel height="310px" :interval="5000">
            <el-carousel-item>
              <a href="http://www.vandream.com/zhubohui/pc/activity.html" style="cursor: pointer">
                <img src="@/assets/reception/firstPage/zhubohui.jpg" alt="">
              </a>
            </el-carousel-item>
            <el-carousel-item>
              <a href="http://www.vandream.com/html/information.html?id=10" style="cursor: pointer">
                <img src="http://mall.vandream.com:8081/group1/M00/01/1F/rBCwI1uFCTWAeanCAAfb0tFqRFs563.jpg" alt="">
              </a>
            </el-carousel-item>
            <el-carousel-item>
              <a href="http://www.vandream.com/index.html" style="cursor: pointer">
                <img src="http://mall.vandream.com:8081/group1/M00/00/26/rBCwJFtDCPmAZ2NbAAJ-ukzBdxY612.jpg" alt="">
              </a>
            </el-carousel-item>
            <el-carousel-item>
              <a href="http://www.vandream.com/index.html" style="cursor: pointer">
                <img src="http://mall.vandream.com:8081/group1/M01/00/26/rBCwI1tDCPmAIeLwAAJaLBXOO1w500.jpg" alt="">
              </a>
            </el-carousel-item>
            <el-carousel-item>
          ...
          <div class="login" v-if="userInfo.userId === '' || userInfo.userId === 'null' || userInfo.userId === undefined">
            ...
            <div class="opeation clearfix">
              <router-link :to="{path:'/register'}">
                <div class="register-btn"><a>免费注册</a></div>
              </router-link>
              <router-link :to="{path:'/login'}">
                <div class="login-btn"><a>登录</a></div>
              </router-link>
            </div>
          </div>
    ...
    <div class="ad" @click="routerJumpcenter"></div>
    <div class="item-list">
      <!-- 第一版 -->
