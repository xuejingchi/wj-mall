<template>
  <div class="homepage">
    ...
    <el-dialog :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false" class="edit-psd-dialog" :visible.sync="showEditPsdBox">
...
<script>
  ...
  import { getAccountFlag, getUserId, getUserInfo, setUserInfo } from '@/utils/auth'
