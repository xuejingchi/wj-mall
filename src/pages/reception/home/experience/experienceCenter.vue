          ...
          <div class="swiper-container">
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                ...
                <iframe style="width: 100%;height: 100%" src="//player.bilibili.com/player.html?aid=27278385&cid=47029595&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
                <!--<video autoplay controls="controls" class="vedio">-->
                  <!--<source  src="http://player.bilibili.com/player.html?aid=27278385&cid=47029595&page=1" type="video/mp4"></source>-->
                <!--</video>-->
              </div>
              <div class="swiper-slide">
      ...
      bannerList: [
        {
          ...
          src: '<iframe src="//player.bilibili.com/player.html?aid=27278385&cid=47029595&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>'
        },
        {
